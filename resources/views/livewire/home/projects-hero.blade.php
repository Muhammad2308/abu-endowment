<div class="projects_hero_area page-hero-area" style="position: relative; background: url('{{ asset('img/ABU SKY IMAGE.jpg') }}') no-repeat center center/cover;">
    ...
    <div class="container page-hero-container" style="position: relative; z-index: 2; height: 100%; display: flex; align-items: center;">
        <div class="row">
            <div class="col-lg-8">
                <div class="hero_text">
                    <h2 class="page-hero-heading" style="color: #fff; font-weight: 700; margin-bottom: 16px; font-family: 'Playfair Display', serif;">Our Projects</h2>
                    <p class="page-hero-sub" style="color: #f3f4f6; line-height: 1.6; max-width: 600px;">
                        Explore the impactful initiatives shaping the future of Ahmadu Bello University. From infrastructure to research, your support makes a difference.
                    </p>
                </div>
            </div>
        </div>

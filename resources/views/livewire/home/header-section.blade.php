                        ...
                        <div class="logo">
                            <a href="{{ url('/') }}" class="d-flex align-items-center" style="text-decoration: none;">
                                ...
                                <div class="logo-text" style="display: flex; flex-direction: column; line-height: 1.2;">
                                    <span style="font-size: 18px; font-weight: 700; color: #fff; letter-spacing: -0.5px;">ALUMNI</span>
                                    <span style="font-size: 12px; font-weight: 400; color: rgba(255,255,255,0.9); letter-spacing: 0.5px;">FUND</span>
                                </div>
                            </a>
                        </div>
                    </div>

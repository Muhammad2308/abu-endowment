        ...
        <button wire:click="openModal" type="button" class="w-full text-left p-6">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <i class="fas fa-landmark text-indigo-600 dark:text-indigo-400 text-3xl"></i>
                </div>
                <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Upload Faculties</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Import a list of faculties</p>
                </div>
            </div>
        </button>
    </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form wire:submit.prevent="import">
                    <div class="p-6 space-y-4">
                        ...
                        @else
                            <div>
                                <input wire:model="upload" type="file" id="faculty_upload" class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                <p class="mt-1 text-xs text-gray-500">XLS, XLSX, CSV. Header: 'faculty_name'</p>

    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
        <div class="relative p-5 border w-full max-w-md shadow-lg rounded-md bg-white dark:bg-gray-800">
            ...
            <form wire:submit.prevent="updatePermission">
                <div class="space-y-4">
                    <div>
                        <label for="edit_permission_title" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Permission Title</label>
                        <input type="text" wire:model.defer="permission_title" id="edit_permission_title" 
